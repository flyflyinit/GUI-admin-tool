...
class CreateFullBackupWindow(QWidget):
    ...
    def layouts(self):
        ...
        #self.pixmap = QMovie("icons/waiting.gif", QByteArray(), self)
        #self.pixmap.setCacheMode(QMovie.CacheAll)
        #self.pixmap.setSpeed(100)
        #self.pixmap.stop()
        #self.waiting.setMovie(self.pixmap)
    ...
    def widgets(self):
        ...
        #self.topLayout.addWidget(self.waiting)
...
class RestoreIncBackupWindow(QWidget):
    ...
    def restoreincbackup(self):
        ...
        try:
            ...
            self.text.setText("error occured during restoring these backups\n")
        else:
...
class MoreFullBackupWindow(QWidget):
    ...
    def layouts(self):
        ...
        #self.container.setContentsMargins(0,30,30,30)     #left ,#top ,#right , #bottom
